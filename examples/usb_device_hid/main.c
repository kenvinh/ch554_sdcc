...
const char sPath[] = "`      C:\\HID_RECV.EXE   \r   ";										// The path for the software. SPACE for delay
const char *pStr = sPath;

uint8_t HIDCom[64] = {0};												
uint8_t HIDKey[8] = {0};

uint16_t TouchKeyButton = 0;	

/**************************** Device Descriptor *************************************/
const uint8_t DevDesc[18] = {																// Device Descriptor
	0x12,0x01,
	0x10,0x01,
	0x00,0x00,
	0x00,0x08,                      
...
const uint8_t KeyRepDesc[65] = 															// Report Descriptor, DELL Keyboard
{
...
const uint8_t ComRepDesc[34] = 															// Report Descriptor, Composite device
{
...
{
    0x09,0x02,9+9+9+7+9+9+7+7,0x00,0x02,0x01,0x00,0xA0,0x32,             						// Configure Descriptor
    ...
    0x07,0x05,0x82,0x03,0x40,0x00,0x32,                        						// Endpoint Descriptor, 50ms, IN
...
static void SendKey ( const char *p )
{
...
{
	static uint8_t rotateFlag = 0;																// When upload keys complete, upload EP2 data
  uint16_t KeyData = TouchKeyButton;
